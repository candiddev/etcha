...
func TestConfigParse(t *testing.T) {
	...
	_, pub1, _ := cryptolib.NewKeysEncryptAsymmetric(cryptolib.AlgorithmBest)
	_, pub2, _ := cryptolib.NewKeysEncryptAsymmetric(cryptolib.AlgorithmBest)
...
func TestParseJWTFile(t *testing.T) {
	...
	prv1, _, _ := cryptolib.NewKeysEncryptAsymmetric(cryptolib.AlgorithmBest)
	_, pub2, _ := cryptolib.NewKeysEncryptAsymmetric(cryptolib.AlgorithmBest)
	prv3, _, _ := cryptolib.NewKeysEncryptAsymmetric(cryptolib.AlgorithmBest)
