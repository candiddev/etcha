...
function(args='', cap_add=[], command='', deviceChown=false, devices=[], engine='', env=[], image, name, network='', options='', ports=[], privileged=false, pull='', restart='on-failure', skipRemove=false, user='', volumes=[], workdir='')
